...
#   ('-f', '')
#   ('-o', '/tmp/generated/python/issnetlib/v1_00/servico_consultar_nfse_resposta.xsd.py')
#
# Command line arguments:
#   /tmp/generated/schemas/issnet/v1_00/servico_consultar_nfse_resposta.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/nfselib.issnet/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/tmp/generated/python/issnetlib/v1_00/servico_consultar_nfse_resposta.xsd.py" /tmp/generated/schemas/issnet/v1_00/servico_consultar_nfse_resposta.xsd
#
...
class ConsultarNfseResposta(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ConsultarNfseResposta', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'ConsultarNfseResposta':
...
class ListaNfseType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('CompNfse', 'tcCompNfse', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'name': 'CompNfse', 'type': 'tcCompNfse'}, None),
    ]
    subclass = None
    superclass = None
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_consultar_nfse_resposta.xsd import *\n\n')
        sys.stdout.write('import servico_consultar_nfse_resposta.xsd as model_\n\n')
...
NamespaceToDefMappings_ = {'http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_consultar_nfse_resposta.xsd': [],

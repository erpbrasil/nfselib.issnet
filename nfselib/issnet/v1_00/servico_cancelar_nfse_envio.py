...
#   ('-f', '')
#   ('-o', '/tmp/generated/python/issnetlib/v1_00/servico_cancelar_nfse_envio.xsd.py')
#
# Command line arguments:
#   /tmp/generated/schemas/issnet/v1_00/servico_cancelar_nfse_envio.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/nfselib.issnet/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/tmp/generated/python/issnetlib/v1_00/servico_cancelar_nfse_envio.xsd.py" /tmp/generated/schemas/issnet/v1_00/servico_cancelar_nfse_envio.xsd
#
...
class CancelarNfseEnvio(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('Pedido', 'tcPedidoCancelamento', 0, 0, {'name': 'Pedido', 'type': 'tcPedidoCancelamento'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, Pedido=None, gds_collector_=None, **kwargs_):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CancelarNfseEnvio', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'CancelarNfseEnvio':
...
class tcInfPedidoCancelamento(GeneratedsSuper):
    ...
    def __init__(self, id=None, IdentificacaoNfse=None, CodigoCancelamento=None, gds_collector_=None, **kwargs_):
        ...
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = GenerateDSNamespaceTypePrefixes_.get('General')
        self.id = _cast(None, id)
        self.id_nsprefix_ = None
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'CancelarNfseEnvio'
        rootClass = CancelarNfseEnvio
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_cancelar_nfse_envio.xsd import *\n\n')
        sys.stdout.write('import servico_cancelar_nfse_envio.xsd as model_\n\n')
...
NamespaceToDefMappings_ = {'http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_cancelar_nfse_envio.xsd': [],

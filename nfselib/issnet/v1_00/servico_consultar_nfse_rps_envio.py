...
#   ('-f', '')
#   ('-o', '/tmp/generated/python/issnetlib/v1_00/servico_consultar_nfse_rps_envio.xsd.py')
#
# Command line arguments:
#   /tmp/generated/schemas/issnet/v1_00/servico_consultar_nfse_rps_envio.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/nfselib.issnet/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/tmp/generated/python/issnetlib/v1_00/servico_consultar_nfse_rps_envio.xsd.py" /tmp/generated/schemas/issnet/v1_00/servico_consultar_nfse_rps_envio.xsd
#
...
class ConsultarNfseRpsEnvio(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, IdentificacaoRps=None, Prestador=None, gds_collector_=None, **kwargs_):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ConsultarNfseRpsEnvio', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'ConsultarNfseRpsEnvio':
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'ConsultarNfseRpsEnvio'
        rootClass = ConsultarNfseRpsEnvio
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_consultar_nfse_rps_envio.xsd import *\n\n')
        sys.stdout.write('import servico_consultar_nfse_rps_envio.xsd as model_\n\n')
...
NamespaceToDefMappings_ = {'http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_consultar_nfse_rps_envio.xsd': [],

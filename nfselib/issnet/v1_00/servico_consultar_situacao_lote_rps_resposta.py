...
#   ('-f', '')
#   ('-o', '/tmp/generated/python/issnetlib/v1_00/servico_consultar_situacao_lote_rps_resposta.xsd.py')
#
# Command line arguments:
#   /tmp/generated/schemas/issnet/v1_00/servico_consultar_situacao_lote_rps_resposta.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/nfselib.issnet/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/tmp/generated/python/issnetlib/v1_00/servico_consultar_situacao_lote_rps_resposta.xsd.py" /tmp/generated/schemas/issnet/v1_00/servico_consultar_situacao_lote_rps_resposta.xsd
#
...
class ConsultarSituacaoLoteRpsResposta(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('Situacao', ['tsSituacaoLoteRps', 'xsd:byte'], 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'Situacao', 'type': 'xsd:byte'}, 1),
    ...
    subclass = None
    superclass = None
    def __init__(self, NumeroLote=None, Situacao=None, ListaMensagemRetorno=None, gds_collector_=None, **kwargs_):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ConsultarSituacaoLoteRpsResposta', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'ConsultarSituacaoLoteRpsResposta':
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_consultar_situacao_lote_rps_resposta.xsd import *\n\n')
        sys.stdout.write('import servico_consultar_situacao_lote_rps_resposta.xsd as model_\n\n')
...
NamespaceToDefMappings_ = {'http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_consultar_situacao_lote_rps_resposta.xsd': [],

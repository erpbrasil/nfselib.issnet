...
#   ('-f', '')
#   ('-o', '/tmp/generated/python/issnetlib/v1_00/servico_consultar_situacao_lote_rps_envio.xsd.py')
#
# Command line arguments:
#   /tmp/generated/schemas/issnet/v1_00/servico_consultar_situacao_lote_rps_envio.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/nfselib.issnet/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/tmp/generated/python/issnetlib/v1_00/servico_consultar_situacao_lote_rps_envio.xsd.py" /tmp/generated/schemas/issnet/v1_00/servico_consultar_situacao_lote_rps_envio.xsd
#
...
class ConsultarSituacaoLoteRpsEnvio(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ConsultarSituacaoLoteRpsEnvio', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'ConsultarSituacaoLoteRpsEnvio':
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_consultar_situacao_lote_rps_envio.xsd import *\n\n')
        sys.stdout.write('import servico_consultar_situacao_lote_rps_envio.xsd as model_\n\n')
...
NamespaceToDefMappings_ = {'http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_consultar_situacao_lote_rps_envio.xsd': [],

...
#   ('-f', '')
#   ('-o', '/tmp/generated/python/issnetlib/v1_00/servico_enviar_lote_rps_envio.xsd.py')
#
# Command line arguments:
#   /tmp/generated/schemas/issnet/v1_00/servico_enviar_lote_rps_envio.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/nfselib.issnet/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/tmp/generated/python/issnetlib/v1_00/servico_enviar_lote_rps_envio.xsd.py" /tmp/generated/schemas/issnet/v1_00/servico_enviar_lote_rps_envio.xsd
#
...
class EnviarLoteRpsEnvio(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('LoteRps', 'tcLoteRps', 0, 0, {'name': 'LoteRps', 'type': 'tcLoteRps'}, None),
        MemberSpec_('Signature', 'SignatureType', 0, 1, {'maxOccurs': '1', 'minOccurs': '0', 'name': 'Signature', 'ref': 'Signature', 'type': 'Signature'}, None),
    ]
    subclass = None
    superclass = None
    def __init__(self, LoteRps=None, Signature=None, gds_collector_=None, **kwargs_):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='EnviarLoteRpsEnvio', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'EnviarLoteRpsEnvio':
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='EnviarLoteRpsEnvio', fromsubclass_=False, pretty_print=True):
        ...
        if self.LoteRps is not None:
            namespaceprefix_ = self.LoteRps_nsprefix_ + ':' if (UseCapturedNS_ and self.LoteRps_nsprefix_) else ''
...
class ReferenceType(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('DigestValue', 'DigestValueType1', 0, 0, {'name': 'DigestValue', 'ref': 'DigestValue', 'type': 'DigestValue'}, None),
    ]
    subclass = None
    superclass = None
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Transforms':
            ...
            obj_ = DigestValueType1.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
...
class DigestValueType1(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, DigestValueType1)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if DigestValueType1.subclass:
            return DigestValueType1.subclass(*args_, **kwargs_)
        else:
            return DigestValueType1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            (1 if type(self.valueOf_) in [int,float] else self.valueOf_)
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='DigestValueType1', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('DigestValueType1')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'DigestValueType1':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='DigestValueType1')
        if self.hasContent_():
            outfile.write('>')
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='DigestValueType1', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DigestValueType1'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='DigestValueType1', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'EnviarLoteRpsEnvio'
        rootClass = EnviarLoteRpsEnvio
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_enviar_lote_rps_envio.xsd import *\n\n')
        sys.stdout.write('import servico_enviar_lote_rps_envio.xsd as model_\n\n')
...
NamespaceToDefMappings_ = {'http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_enviar_lote_rps_envio.xsd': [],

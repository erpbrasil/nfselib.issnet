...
#   ('-f', '')
#   ('-o', '/tmp/generated/python/issnetlib/v1_00/servico_cancelar_nfse_resposta.xsd.py')
#
# Command line arguments:
#   /tmp/generated/schemas/issnet/v1_00/servico_cancelar_nfse_resposta.xsd
#
# Command line:
#   /Users/marcelsavegnago/Projetos/odoo/python-libs/nfselib.issnet/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/tmp/generated/python/issnetlib/v1_00/servico_cancelar_nfse_resposta.xsd.py" /tmp/generated/schemas/issnet/v1_00/servico_cancelar_nfse_resposta.xsd
#
...
class CancelarNfseResposta(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('Cancelamento', 'tcCancelamentoNfse', 0, 0, {'name': 'Cancelamento', 'type': 'tcCancelamentoNfse'}, 1),
    ...
    subclass = None
    superclass = None
    def __init__(self, Cancelamento=None, ListaMensagemRetorno=None, gds_collector_=None, **kwargs_):
        ...
        self.Cancelamento_nsprefix_ = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CancelarNfseResposta', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'CancelarNfseResposta':
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CancelarNfseResposta', fromsubclass_=False, pretty_print=True):
        ...
        if self.Cancelamento is not None:
            namespaceprefix_ = self.Cancelamento_nsprefix_ + ':' if (UseCapturedNS_ and self.Cancelamento_nsprefix_) else ''
            self.Cancelamento.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Cancelamento', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Cancelamento':
            ...
            obj_.original_tagname_ = 'Cancelamento'
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'CancelarNfseResposta'
        rootClass = CancelarNfseResposta
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_cancelar_nfse_resposta.xsd import *\n\n')
        sys.stdout.write('import servico_cancelar_nfse_resposta.xsd as model_\n\n')
...
NamespaceToDefMappings_ = {'http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_cancelar_nfse_resposta.xsd': [],
